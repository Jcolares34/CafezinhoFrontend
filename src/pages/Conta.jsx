      ...
      <div style={{ display: "flex", marginTop: "20px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "10px", marginTop: "22px" }}>
            <button
              style={{ backgroundColor: "#f0f0f0", border: "none", padding: "10px 20px", borderRadius: "5px", display: "flex", alignItems: "center", gap: "5px" }}
              onClick={() => window.location.href = "http://localhost:3000/conta/alterarsenha"}
            >
              <i className="fas fa-lock"></i> Alterar Senha
            </button>
            <button
              style={{ backgroundColor: "#000", color: "#fff", border: "none", padding: "10px 20px", borderRadius: "5px", display: "flex", alignItems: "center", gap: "5px" }}
              onClick={() => window.location.href = "http://localhost:3000/conta/editardados"}
            >
